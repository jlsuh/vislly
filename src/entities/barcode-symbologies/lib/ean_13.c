...
static const char *const PARITY_PATTERNS[DIGITS_COUNT] = {"LLLLLL", "LLGLGG", "LLGGLG", "LLGGGL", "LGLLGG",
                                                          "LGGLLG", "LGGGLL", "LGLGLG", "LGLGGL", "LGGLGL"};

static const char *const ENCODING_TABLE[DIGITS_COUNT][EAN13_ENCODING_TYPES_COUNT] = {
