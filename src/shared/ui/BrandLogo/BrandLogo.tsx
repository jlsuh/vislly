  ...
  return (
    <a className={styles.brandLink} href="/">
      ...
      >
        ...
        />
        <path
          className={styles.brandPath_fill_colorOutlineVariant}
        ...
        />
        <path
          className={styles.brandPath_stroke_colorInverseOnSurface}
        ...
        />
        <path
          className={styles.brandPath_fill_colorInverseOnSurface}
